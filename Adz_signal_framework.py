            ...
            if len(data) > 1 and bool(data['updated']) and float(data['price']) > 0:
                ...
                if len(CoinAlreadyBought.index) == 0:
                    ...
                    if symbol in held_coins_list.index:
                        ...
                        curve_5m = float(TA_5m['trima'])
                        sma_5m = float(TA_5m['sma'])
                        curve_1m = float(TA_1m['trima'])
                        sma_1m = float(TA_1m['sma'])
                        ...
                        if TimeFrameOption:
                            ...
                            if RealTimeCheck:
                                TimeFrameCheck = (sma_5m > curve_5m)
                                if RealTimeCheck:
                                    TimeFrameCheck = (sma_1m > curve_1m)
                                if TimeFrameCheck:
                                    BuyCoin = True
