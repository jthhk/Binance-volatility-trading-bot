...
def init():
    ...
    global TAKE_PROFIT, STOP_LOSS,CHANGE_IN_PRICE,REF_COIN,BACKTEST_FILE,BACKTEST_RECORD,MARKET_DATA_INTERVAL,TICKERS_LIST,MARKET_DATA_MODULE,COOLOFF_PERIOD
